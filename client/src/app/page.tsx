      ...
      <div className="px-6 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-left">
          {resources.map((item, idx) => (
            <div
              key={idx}
              className="bg-[#0f172a] py-12 px-10 rounded-xl shadow-md text-white duration-300 hover:scale-105 hover:border-2 hover:border-blue-500"
            >
              ...
              <Link href={item.link} className="px-4 py-2 mt-5  bg-gradient-to-b from-[#698aed] to-[#2861db] hover:bg-blue-700 rounded-4xl text-white text-2xl font-semibold hover:cursor-pointer">
                {item.btn}
              </Link>
